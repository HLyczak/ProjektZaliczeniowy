    ...
    public class GabinetContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Patient>().HasData
                (new Patient { Id = 1, Name = "Adam Nowak ", Adress = " Magnoliowa 5", Pesel = 85011259884, RoleId = 3 },
                new Patient { Id = 2, Name = "Zofia Stefaniuk", Adress = " Ostoja 5", Pesel = 78020607221, RoleId = 2 },
                new Patient { Id = 3, Name = "Austen Nowaki", Adress = " Żeromskiego 4", Pesel = 95011259884, RoleId = 2 },
                new Patient { Id = 4, Name = "Grzegorz Fus", Adress = " Obozowa 15", Pesel = 65011259884, RoleId = 2 }
                 );
            modelBuilder.Entity<Nurse>().HasData
                (new Nurse { Id = 1, NameSurname = "AZofia Stanecka", Adress = " Różana 5", PermissionNumber = " 509853", RoleId = 1 },
                new Nurse { Id = 2, NameSurname = "Hanna Oklejka", Adress = " Topografów 5", PermissionNumber = " 510053", RoleId = 3, },
                new Nurse { Id = 3, NameSurname = "Anna Austen", Adress = " os. Kolorowe 8", PermissionNumber = " 169053", RoleId = 3 },
                new Nurse { Id = 4, NameSurname = "Glżbieta Lem", Adress = " Obozowa 14", PermissionNumber = " 567053", RoleId = 3 }
                 );

            modelBuilder.Entity<Doctor>().HasData
               (new Doctor { Id = 1, NameSurname = "Adam Kowalski", Adress = " Kolorowa 5", PermissionNumber = " 569853", RoleId = 3, SpecializationId = 1 },
               new Doctor { Id = 2, NameSurname = "Zofia Kowalski", Adress = " Zielona 5", PermissionNumber = " 560053", RoleId = 3, SpecializationId = 2 },
               new Doctor { Id = 3, NameSurname = "Todor Nowaki", Adress = " Adama Mickiewicza 8", PermissionNumber = " 160053", RoleId = 3, SpecializationId = 3 },
               new Doctor { Id = 4, NameSurname = "Grzegorz Lem", Adress = " Obozowa 8", PermissionNumber = " 560053", RoleId = 3, SpecializationId = 4 }
                );
